...
def main():
    ...
    for me in welcome:
        print(me, sep='\n') #sep<- separator between arguments to print()
    ...
    while play_again:
        ...
        words = ["hangman", "chairs", "backpack", "bodywash", "clothing",
                 ...
                 "algebra", "suitcase", "knives", "ninjas", "shampoo", "booktok", "science", "development"
                 ]

        chosen_word = random.choice(words).lower() #randomly choose a word
